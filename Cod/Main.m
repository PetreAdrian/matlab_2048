...
while 1
    ...
    % Code 0: Normal Game
    if CheckCode == 1 
        questdlg ('Bravo! Ai castigat! Apasa OK pentru a restarta jocul sau a iesi','Bravo!','OK', 'OK');
    end
    ...
    if StatusW == 0 && StatusS == 0 && StatusA == 0 && StatusD == 0
        questdlg ('Ai pierdut :( . Apasa OK pentru a restarta jocul sau a iesi','Game Over','OK', 'OK');
        CheckCode = 3;
    end
    waitforbuttonpress;
    ...
    switch input
        ...
        case 6 % quit command
            ...
            cla;
            axis ([1 5 1 5]);
            text (1, 3, 'Multumesc pentru ca ai jucat!', 'FontName', 'Arial', 'FontSize', 40);
            pause(3);
            close;
            return;
        case 5
